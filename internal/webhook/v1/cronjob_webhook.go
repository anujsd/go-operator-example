...
import (
	...
	batchv1 "github.com/anujsd/cronjob-controller/api/v1"
)
...
// +kubebuilder:webhook:path=/mutate-batch-github-com-v1-cronjob,mutating=true,failurePolicy=fail,sideEffects=None,groups=batch.github.com,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-batch-github-com-v1-cronjob,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.github.com,resources=cronjobs,verbs=create;update,versions=v1,name=vcronjob-v1.kb.io,admissionReviewVersions=v1
